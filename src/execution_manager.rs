...
impl ExecutionManager {
    ...
    fn spawn_gameboy_thread(breakpoints: Arc<Mutex<HashSet<u16>>>, pause_state: Arc<Mutex<PauseState>>, global_time: Arc<Mutex<u128>>, mut gameboy_state: GameBoyState, test_mode: bool) -> JoinHandle<Result<String, String>> {
    ...
    pub fn run(&mut self, gameboy_state: GameBoyState) {
        let gameboy_join_handle = Self::spawn_gameboy_thread(self.breakpoints.clone(), self.pause_state.clone(), self.global_time.clone(), gameboy_state, false);
